...
function Navbar() {
    ...
    return (
        <header className={`block w-10/12 mx-auto text-nowrap font-bold m-0 text-white font-work-sans absolute justify-center ${hamburgerIcon ? 'absolute' : 'max-md:relative'}`}>
